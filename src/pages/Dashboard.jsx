                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <div className={`relative w-12 h-12 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-lg ${booking.status === 'checked-in'
                        ...
                        {booking.groupSize > 1 && (
                          <div className="absolute -top-1 -right-1 w-5 h-5 bg-orange-500 rounded-full flex items-center justify-center text-xs font-bold text-white border-2 border-white">
                            {booking.groupSize}
                          </div>
                        )}
                    ...
                    <div className="text-right space-y-2">
                      <div className="flex flex-col items-end">
                        ...
                        {/* Group summary for large groups */}
                        {booking.groupSize > 3 && (
                          <div className="mt-1 px-2 py-1 bg-orange-50 border border-orange-200 rounded-md">
                            <p className="text-xs text-orange-700 font-medium">Large Group</p>
                            <p className="text-xs text-orange-600">{booking.groupSize} members</p>
                          </div>
                        )}
                      </div>
                    </div>
